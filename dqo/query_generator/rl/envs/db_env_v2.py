...
from dqo.query_generator.rl import Log2Partitioner
...
class DatabaseEnvV2(Env):
    ...
    def __init__(self, db_client: DatabaseClient, ctx: dict = None):
        ...
        self.steps = 0
        self.episode = 0
        self.target = DatabaseEnvV2.BAD_STATE
        self.state = DatabaseEnvV2.BAD_STATE
        self.qb = None
    ...
    def step(self, action: ActionType, cb: Callable[[str, float], None] = None) -> StepResult:
        ...
        observation = DatabaseEnvV2.BAD_STATE
        took = -1
        reward = -10
        done = False
