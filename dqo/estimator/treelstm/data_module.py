...
from dqo.estimator.treelstm.dataset import BucketedQueriesDataset, ConcatQueriesDataSet
...
class QueriesDataModule(pl.LightningDataModule):
    ...
    def __init__(self, datasets: Union[str, List[str]], encoder, split_kind: str = 'default', frac: float = 1.0, split=(.8, .2)):
        """
        :param datasets:
    ...
    def setup(self, stage=None):
        ...
        self.ds = ConcatQueriesDataSet([BucketedQueriesDataset(ds, encode_query=self.encoder.encode_query) for ds in self.dataset_names])
    ...
    def test_dataloader(self):
        ...
        return DataLoader(self.ds, num_workers=0, batch_size=1, sampler=self.test_sampler, collate_fn=lambda x: x)
