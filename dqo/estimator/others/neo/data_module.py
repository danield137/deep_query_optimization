...
import numpy as np
from dqo.estimator.others.neo.dataset import BucketedQueriesDataset, ConcatQueriesDataSet
...
class QueriesDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.ds = ConcatQueriesDataSet([BucketedQueriesDataset(ds, encode_query=self.encoder.encode_query, value_transform=self.value_transform) for ds in self.dataset_names])
