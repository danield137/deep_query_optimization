...
if __name__ == '__main__':
    ...
    tb_logger = pl_loggers.TensorBoardLogger('logs/', name="smart")
    conf = dict(
    ...
    queries_dm = QueriesDataModule(['tpch:optimized:train', 'tpch_alt:optimized:train', 'tpch_alt_val:optimized:train', 'tpcds:optimized:train', 'imdb:optimized:train'], encoder, split_kind='smart')
