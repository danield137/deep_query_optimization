...
if __name__ == '__main__':
    ...
    tb_logger = pl_loggers.TensorBoardLogger('logs/', name="mixed")
    conf = dict(
    ...
    queries_dm = QueriesDataModule(['tpch:optimized:train', 'tpch_alt:optimized:train', 'tpch_alt_val:optimized:train', 'tpcds:exec_time_aug:train', 'imdb:exec_time_aug:train'], encoder)
