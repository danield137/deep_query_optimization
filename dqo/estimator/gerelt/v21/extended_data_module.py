...
from dqo.estimator.gerelt.v15.extended_dataset import BucketedExtendedQueriesDataset, ConcatExtendedQueriesDataSet
...
class QueriesDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.ds = ConcatExtendedQueriesDataSet(
            [BucketedExtendedQueriesDataset(ds, encode_query=self.encoder.encode_query, value_transform=self.value_transform) for ds in self.dataset_names])
